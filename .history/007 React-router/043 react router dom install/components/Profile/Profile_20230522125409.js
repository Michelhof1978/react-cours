...
"Profil ID: 123". Si l'utilisateur navigue vers `/profil/abc`, le composant affichera "Profil ID: abc". Dans chaque cas, `useParams` est utilisé pour récupérer la valeur actuelle de `:id`.
