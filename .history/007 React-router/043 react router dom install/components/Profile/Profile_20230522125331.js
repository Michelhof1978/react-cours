...
`useParams` est un hook personnalisé de la bibliothèque `react-router-dom` en React.js. Un hook est
 une fonction qui vous permet d'utiliser les fonctionnalités de React, comme l'état et le cycle de vie, dans les composants fonctionnels. `useParams` est un hook qui permet de récupérer les paramètres de l'URL actuelle.
