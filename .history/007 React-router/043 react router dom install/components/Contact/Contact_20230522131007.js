...
`useLocation` est un hook personnalisé provenant de la bibliothèque `react-router-dom` en React.js.
 Un hook est une fonction qui permet d'utiliser les fonctionnalités de React dans les composants fonctionnels. `useLocation` est un hook qui permet d'accéder à l'objet de l'emplacement actuel, qui contient des informations sur l'URL actuelle.
