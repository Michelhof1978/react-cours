...
1. `import React, {useContext} from 'react'`: Vous importez React, ainsi que l'hook `useContext` de la bibliothèque React.

2. `import './BtnToggle.css'`: Vous importez les styles pour ce composant.

3. `import {ThemeContext} from '../../Context/ThemeContext'`: Vous importez le `ThemeContext` que vous avez créé dans un autre fichier. Vous allez utiliser ce contexte pour accéder à l'état du thème et à la fonction pour basculer entre les thèmes.
