...
Si le `theme` est vrai (c'est-à-dire que le thème sombre est activé), le bouton aura la classe
 `btn-toggle dark-btn` et affichera "DARK". Si le `theme` est faux (c'est-à-dire que le thème 
 clair est activé), le bouton aura la classe `btn-toggle` et affichera "LIGHT".