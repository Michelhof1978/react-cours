...
`toggleTheme` et `theme` comme valeurs du contexte, ce qui signifie que ces valeurs seront accessibles à tous les composants enfants enveloppés par `ThemeContextProvider`.
