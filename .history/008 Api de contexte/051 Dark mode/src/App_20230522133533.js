...
composant `Content` avec le `ThemeContextProvider`. Cela signifie que toutes les valeurs et fonctionnalités fournies par le `ThemeContextProvider` seront disponibles pour le composant `Content` et tous ses sous-composants.
