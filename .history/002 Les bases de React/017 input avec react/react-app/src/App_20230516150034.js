...
const changeInput = (e) => {//Sera déclenché grâce à l événement onInput ci dessous dés que l on écrit ds le input
  ...
  Event de l'événement "input" déclenché lorsque l'utilisateur saisit ou modifie la valeur du champ de saisie. Cette fonction met à jour la valeur de inputData en utilisant setInputData avec la valeur actuelle du champ de saisie (e).
