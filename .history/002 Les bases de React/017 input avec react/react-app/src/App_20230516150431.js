...
à chaque fois que l'utilisateur saisit ou modifie la valeur. La valeur actuelle de inputData est également affichée dans la console à chaque mise à jour.
export default App;
