...
const changeInput = (e) => {//Sera déclenché grâce à l événement onInput ci dessous dés que l on écrit ds le input
  ...
  return (
    <div className="App">
      ...
      modifie la valeur du champ de saisie, cette fonction sera appelée avec la valeur actuelle du champ de saisie (e.target.value) en tant que paramètre. Cela déclenchera la fonction changeInput qui mettra à jour inputData avec cette valeur.
      />
