...
function App() {
  ...
  return (
    <div className="App">
      ...
      //e.target.value =  fait référence à la valeur actuelle de l'élément qui a déclenché l'événement. Dans ce cas, il s'agit de la valeur du champ de saisie au moment de l'événement "input".
      />
