...
d'entrée de l'application. Il est responsable du rendu de votre composant "App" de niveau supérieur
 ...
 - `<React.StrictMode>` : il s'agit d'un composant wrapper qui vérifie les problèmes potentiels dans
  l'application pendant le développement. Cela n'a pas d'impact sur les builds de production. C'est une bonne pratique de l'utiliser, même si ce n'est pas obligatoire.
