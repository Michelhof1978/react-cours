...
`toggleMenu` est vrai ou si `largeur` est supérieur à 500. Ensuite, vous avez un bouton qui bascule l'état `toggleMenu` lorsque vous cliquez dessus, montrant efficacement ou masquer les éléments de navigation.
