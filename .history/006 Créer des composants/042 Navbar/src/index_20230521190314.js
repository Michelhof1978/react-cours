...
d'entrée de l'application. Il est responsable du rendu de votre composant "App" de niveau supérieur
 ...
 ReactDOM.render()` : il s'agit d'une fonction fournie par React qui est utilisée pour restituer les composants React au DOM. Il prend deux arguments : le composant React que vous souhaitez rendre et l'élément DOM dans lequel vous souhaitez rendre le composant.
