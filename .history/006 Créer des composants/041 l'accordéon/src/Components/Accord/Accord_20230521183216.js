...
qui définit sa hauteur en fonction de l'état `toggle`. Si `toggle` est vrai (l'utilisateur a cliqué et l'accordéon est ouvert), la hauteur est définie sur la hauteur du contenu. Si `toggle` est faux (l'accordéon est fermé), la hauteur est définie sur `0px`.
