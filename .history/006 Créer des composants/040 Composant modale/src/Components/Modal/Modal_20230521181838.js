...
export default function Modal() {
  ...
  {/* //         <div className="overlay"> `overlay` est utilisée pour créer une sorte de fond semi-transparent qui s'étend sur toute la page lorsqu'une fenêtre modale est
...
// - `onClick={toggleModal}`: C'est un gestionnaire d'événements qui appelle la fonction 
// `toggleModal` lorsque vous cliquez sur le bouton "Open" ou "CLOSE".

// // Dans l'ensemble, ce composant affiche un bouton "Open" qui, lorsqu'il est cliqué, ouvre une 
// fenêtre modale avec un texte. Vous pouvez fermer la fenêtre modale en cliquant sur le bouton 
// "CLOSE".