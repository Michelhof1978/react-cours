...
export default function Modal() {
  ...
  return (
    <>
      ...
      {modal && (
        <div className="overlay">Dans le contexte de votre code, la `<div>` avec la classe `overlay` est utilisée pour créer une sorte de fond semi-transparent qui s'étend sur toute la page lorsqu'une fenêtre modale est ouverte. C'est une technique couramment utilisée pour attirer l'attention sur le contenu de la fenêtre modale et pour indiquer que les éléments en dehors de la fenêtre modale sont temporairement indisponibles pendant que la fenêtre modale est ouverte.
        ...
        Cela signifie que le `overlay` couvrira tout l'écran et aura un fond semi-transparent (dans ce cas, un noir à 50% d'opacité). Il utilise également Flexbox pour centrer la fenêtre modale (`modal`) à l'intérieur de lui-même.
          <div className="modal">
