...
seul élément, `Modal`. Vous pourriez simplement retourner `<Modal />` sans les fragments. Les fragments sont utiles lorsque vous avez plusieurs éléments à renvoyer, par exemple :
