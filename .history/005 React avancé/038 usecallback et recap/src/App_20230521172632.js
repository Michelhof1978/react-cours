...
4. Vous utilisez ensuite le composant `Content` que vous avez importé, et vous lui passez un titre
 sous forme de children. Cependant, vous ne passez pas la variable `tableau` ou la fonction `foo` à `Content` ou à tout autre endroit dans votre code, donc actuellement ces hooks n'ont aucun effet sur votre application.
