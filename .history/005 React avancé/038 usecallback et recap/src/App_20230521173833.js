...
function App() {
  ...
  const foo = useCallback(() => {//On l utilise rarement mais si on en a besoins comme comme des fonctions qui ont plusieurs fonctions à l intérieur de celle ci et qui nécéssissent de gros calculs
    console.log("click");
  }, [])
