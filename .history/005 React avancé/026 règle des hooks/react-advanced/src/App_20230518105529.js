...
function App() {
  ...
  },[dataComponent]);//Le tableau va surveiller le state, si rien à l intérieur, c'est que l on a rien envie de surveiller, si vide, cela fera un appel unique et sera 
