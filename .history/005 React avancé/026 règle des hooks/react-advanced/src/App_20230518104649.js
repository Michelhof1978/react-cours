...
function App() {
  ...
  useEffect(() => {//Le Hook useEffect() en React est un outil puissant qui vous permet d'exécuter du code sous certaines conditions, ou après que certaines choses se soient produites dans votre composant.
