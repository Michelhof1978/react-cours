...
5. Dans le rendu (`return`), trois vidéos sont créées avec `addToRef` comme référence. Ceci signifie
 que lorsqu'une vidéo est rendue, elle est ajoutée à `ref`. Un bouton est également rendu qui, lorsqu'il est cliqué, exécute `toggleFunc`, qui inverse la valeur de `toggle`.
