...
C'est la fonction de nettoyage de notre "useEffect". Cette fonction sera appelée quand le composant
 sera désinstallé. Elle est utilisée pour nettoyer tout effet secondaire que notre "useEffect" a créé. Dans ce cas, elle efface l'intervalle que nous avons créé avec "setInterval" en utilisant son ID.
