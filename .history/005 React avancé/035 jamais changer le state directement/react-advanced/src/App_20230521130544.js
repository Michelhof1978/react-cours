...
ajoute un nouveau caractère à la fin du tableau, et `setToggle` met à jour l'état. Dans le rendu, les caractères sont réunis en une seule chaîne avec `.join('')` pour l'affichage.