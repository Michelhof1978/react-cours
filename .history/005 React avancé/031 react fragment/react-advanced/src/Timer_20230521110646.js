...
5. `return (...)`: Cette partie du code renvoie le JSX qui sera rendu par le composant. Dans ce cas,
 4 titres `<h1>` affichant la valeur courante de `timer` sont rendus. Notez l'utilisation de `<>` et `</>` (des fragments de React), qui permettent de regrouper plusieurs éléments JSX sans ajouter de noeud supplémentaire à l'arbre DOM.
