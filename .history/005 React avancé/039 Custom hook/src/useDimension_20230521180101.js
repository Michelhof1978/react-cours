...
export default function useDimension(){//Va retourner soit une fonction, soit une valeur
    ...
    useEffect(() => {
        ...
        function resizeFunc(){ //window.innerWidth est une propriété du navigateur qui renvoie la largeur intérieure de la fenêtre du navigateur en pixels. Cette valeur comprend la largeur de la zone de contenu de la fenêtre, mais exclut les barres d'outils et les barres de défilement.
        }
        resizeFunc();
