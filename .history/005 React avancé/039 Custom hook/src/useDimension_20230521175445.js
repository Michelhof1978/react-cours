...
`window`. Ce gestionnaire d'événement est la fonction `resizeFunc()`, qui met à jour `dimension` pour être la largeur actuelle de la fenêtre chaque fois que l'événement 'resize' se produit.
