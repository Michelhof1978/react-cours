...
export default function useDimension(){//Va retourner soit une fonction, soit une valeur
    ...
    useEffect(() => {
        ...
        window.addEventListener('resize', resizeFunc);// On ajoute un écouteur d'événements à l'objet window du navigateur. Plus précisément, il écoute l'événement 'resize'.

        L'événement 'resize' est déclenché chaque fois que la fenêtre du navigateur est redimensionnée. Lorsque cet événement se produit, la fonction resizeFunc est appelée.
