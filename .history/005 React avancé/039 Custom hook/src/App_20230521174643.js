...
// Ce hook utilise l'API `window.innerWidth` pour obtenir la largeur du navigateur, puis il utilise 
// l'événement 'resize' pour mettre à jour cette valeur chaque fois que la fenêtre est redimensionnée.

// Avec ce hook, votre composant `App` fonctionnera comme prévu, en affichant "Grand écran" ou 
// "Petit écran" dans la console en fonction de la largeur du navigateur.