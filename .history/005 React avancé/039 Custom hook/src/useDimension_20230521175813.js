...
export default function useDimension(){//Va retourner soit une fonction, soit une valeur
    ...
    useEffect(() => {
        ...
        window.addEventListener('resize', resizeFunc);// ajoute un écouteur d'événements à l'objet window du navigateur. Plus précisément, il écoute l'événement 'resize'.
