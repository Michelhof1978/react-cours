...
export default function useDimension(){//Va retourner soit une fonction, soit une valeur
    ...
    useEffect(() => {
        ...
        // En bref, cette ligne de code signifie : "Lorsque la fenêtre du navigateur est redimensionnée,
        //  exécutez la fonction resizeFunc".Dans le contexte de votre code, cela signifie que chaque 
        //  fois que la fenêtre est redimensionnée, vous mettez à jour l'état dimension pour qu'il 
        //  corresponde à la nouvelle largeur de la fenêtre.

        function resizeFunc(){
            setDimension(window.innerWidth)window.innerWidth est une propriété du navigateur qui renvoie la largeur intérieure de la fenêtre du navigateur en pixels. Cette valeur comprend la largeur de la zone de contenu de la fenêtre, mais exclut les barres d'outils et les barres de défilement.
        }
        resizeFunc();
