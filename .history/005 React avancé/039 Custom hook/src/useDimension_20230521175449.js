...
Une chose importante à noter est que dans la fonction de nettoyage, vous utilisez à nouveau 
`addEventListener`, qui est une erreur courante. Vous vouliez probablement utiliser `removeEventListener` à la place pour supprimer le gestionnaire d'événements :
