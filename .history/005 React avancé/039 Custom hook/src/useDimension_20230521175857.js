...
export default function useDimension(){//Va retourner soit une fonction, soit une valeur
    ...
    useEffect(() => {
        ...
        En bref, cette ligne de code signifie : "Lorsque la fenêtre du navigateur est redimensionnée,
         exécutez la fonction resizeFunc".Dans le contexte de votre code, cela signifie que chaque fois que la fenêtre est redimensionnée, vous mettez à jour l'état dimension pour qu'il corresponde à la nouvelle largeur de la fenêtre.
