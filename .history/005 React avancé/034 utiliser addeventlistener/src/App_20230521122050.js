...
référence, ce qui signifie que chaque élément vidéo sera ajouté à `ref.current`. Le bouton a `toggleFunc` comme gestionnaire de clic, ce qui signifie que `toggleFunc` sera appelé chaque fois que le bouton est cliqué.
