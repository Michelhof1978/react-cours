...
Si vous n'enlevez pas cet événement lorsque le composant est démonté, cela pourrait causer des fuites de mémoire, car la fonction actionResize continuerait à s'exécuter en arrière-plan même si le composant n'est plus présent dans le DOM.
