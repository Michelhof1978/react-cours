...
chaque fois que l'événement `resize` est déclenché. Elle affiche simplement "Resized !!!!" dans la console. Lorsque le composant est démonté, l'écouteur d'événement est supprimé pour éviter les fuites de mémoire.
