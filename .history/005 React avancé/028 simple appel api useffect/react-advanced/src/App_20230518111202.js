...
créer une variable d'état `dataImg`. Cette variable stocke l'URL de l'image de chat que nous récupérons de l'API. La fonction `setDataImg` est utilisée pour mettre à jour cette variable.
