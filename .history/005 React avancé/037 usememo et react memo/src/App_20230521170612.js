...
l'état `toggle`. Cependant, cette action n'affecte pas directement ce qui est rendu dans l'interface utilisateur, à moins que vous utilisiez également `toggle` quelque part dans votre rendu.
