...
Veuillez noter que les méthodes `` incrfunc 'et «décrfunc» ne sont actuellement pas utilisées.
 Si vous n'en avez pas besoin, vous pouvez les supprimer. De plus, la charge utile de l'action «addcart» devrait être un nombre. Veuillez vous assurer que «Cartdata» est converti en nombre avant d'envoyer l'action.