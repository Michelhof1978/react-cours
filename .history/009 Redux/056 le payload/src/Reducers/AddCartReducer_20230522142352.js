...
Je vois que vous avez fourni le code pour le contre-réducteur. C'est un bon début pour gérer l'état
 lié à l'incrémentation et à la décrémentation d'une valeur de comptage. Juste une petite note -
  c'est généralement une bonne pratique de gérer le cas par défaut dans votre instruction Switch dans Reducers Redux. Ce cas renverrait l'état actuel lorsqu'aucun type d'action correspondant n'est trouvé:
