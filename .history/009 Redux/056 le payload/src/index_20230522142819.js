...
votre magasin Redux. Si vous souhaitez utiliser plusieurs réducteurs (dans ce cas, `Counterreducer` et« addCartreducer »), vous devrez les combiner à l'aide de la fonction« CombineReducers »de Redux.
