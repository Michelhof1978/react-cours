...
Dans votre configuration actuelle, vous ne fournissez qu'un seul réducteur («addcartreducer») à votre magasin Redux. Si vous souhaitez utiliser plusieurs réducteurs (dans ce cas, `Counterreducer` et« addCartreducer »), vous devrez les combiner à l'aide de la fonction« CombineReducers »de Redux.
...
`` '
Maintenant, les deux réducteurs sont inclus dans votre magasin Redux. Dans votre composant, vous accèderiez à l'état comme ceci:
