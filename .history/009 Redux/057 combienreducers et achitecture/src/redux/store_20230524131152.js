...
3. Création de «rootReducer» à l'aide de «combinairs». Cela fait en sorte que lorsqu'une action
 est envoyée, «CombinerEducers» déléguera le traitement de cette action au réducteur spécifique en fonction de la clé que vous avez définie dans l'objet `CombinerDucers». Dans votre cas, les clés sont «contre-réducteurs» et «addcartreducer».
