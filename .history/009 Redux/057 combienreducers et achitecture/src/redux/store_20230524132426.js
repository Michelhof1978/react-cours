...
1. Vous importez `createStore` et `combineReducers` de la bibliothèque Redux. `createStore` est
 une fonction qui génère un magasin Redux avec votre reducer racine, et `combineReducers` est une fonction utilitaire pour combiner vos différents reducers en un seul.
