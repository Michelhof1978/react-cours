...
1. Importation de «Createstore» et «CombinerEducers» de la bibliothèque Redux. «Createstore» est une fonction qui génère une boutique Redux avec votre réducteur racine et `combinée» est une fonction utilitaire pour combiner vos multiples réducteurs en un.

2. Importation de «contre-réducteurs» et «addcartreducer» qui sont deux fichiers réducteur distincts. Un réducteur est une fonction qui décide comment mettre à jour l'état en réponse à toute action envoyée au magasin.
