...
l'état. C'est généralement une bonne pratique d'utiliser Redux lorsque vous avez plusieurs états ou des états complexes de votre application. Décrivons ce qui se passe dans votre code:
