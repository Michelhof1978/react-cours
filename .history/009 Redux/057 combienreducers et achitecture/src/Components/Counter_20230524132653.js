...
// assurez-vous que votre store Redux est correctement fourni à un niveau supérieur dans votre
//  arborescence de composants en utilisant le composant `Provider` de `react-redux`.
