...
Veuillez noter que la modification de toutes les actions en une seule action spécifique, comme dans 
cet exemple, est probablement une mauvaise idée dans une application réelle. C'est juste un exemple 
pour illustrer comment un middleware peut modifier les actions. Dans la pratique, vous devriez utiliser un middleware pour effectuer des tâches utiles, comme gérer les actions asynchrones, logger les actions et l'état, ou conditionnellement transformer certaines actions.