...
3. Vous définissez un middleware personnalisé `customMiddleware`. Ce middleware intercepte chaque
 ...
 payload de `789`, peu importe l'action initiale. 
   ...
   comme une logique asynchrone ou des transformations d'action conditionnelles. Cependant, ce code démontre le concept de base : un middleware peut inspecter, modifier, retarder ou ignorer les actions dispatchées.
