...
pour lire la valeur` Count »actuelle de l'état redux. La pièce `state => state.Count` est une fonction sélective qui obtient l'état redux comme un argument et renvoie la propriété« Count »de celui-ci.
