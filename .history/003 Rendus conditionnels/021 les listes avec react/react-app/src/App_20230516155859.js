...
reçoit trois arguments : `item` (l'élément en cours d'itération), `index` (l'index de l'élément) et `array` (le tableau d'origine). Dans ce cas, nous n'utilisons que `item` et `index`.
