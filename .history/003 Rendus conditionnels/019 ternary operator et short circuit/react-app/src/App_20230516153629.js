...
export default App;
Ce code représente un composant React qui utilise un état (`toggle`) pour contrôler l'affichage conditionnel d'un élément `<h1>` et permet à l'utilisateur de changer cet état en cliquant sur un bouton.
