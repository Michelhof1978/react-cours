...
avec une valeur initiale de `false`. Cela signifie que `toggle` sera le nom de la variable qui stocke l'état actuel, et `setToggle` sera la fonction utilisée pour mettre à jour cet état.
